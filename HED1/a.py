...
parser.add_argument('--width', help='Resize input image to a specific width', default=1000, type=int)
parser.add_argument('--height', help='Resize input image to a specific height', default=1000, type=int)
